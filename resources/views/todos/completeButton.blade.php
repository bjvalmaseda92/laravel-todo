@if ($todo->completed)
                        ...
                        <form method="post" id="{{'form-incomplete-'.$todo->id}}" class="hidden" action="{{ route('todo.incomplete', $todo) }}">
                            @csrf
                            @method('delete')
                        </form>
                    ...
                    @else
                        ...
                        <form method="post" id="{{'form-complete-'.$todo->id}}" class="hidden" action="{{ route('todo.complete', $todo) }}">
                            @csrf
                            @method('put')
                        </form>
                    @endif